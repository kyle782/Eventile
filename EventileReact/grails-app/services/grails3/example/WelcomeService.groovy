...
class WelcomeService {
    ...
    ArrayList<Event> search(String location){
        ...
        if (location){
            ...
            response_eventbrite = new RestBuilder().get("https://www.eventbriteapi.com/v3/events/search/?location.address={query}"){
                header "Authorization", "Bearer 2S34UCIHKW5MXVP4S5M7" // authenticate with header
                urlVariables query:location
            }
