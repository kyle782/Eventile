...
- Grails will then resolve all dependenciew and start the application server. Navigate to (localhost:8080)[localhost:8080] in your favourite web browser to enjoy.
